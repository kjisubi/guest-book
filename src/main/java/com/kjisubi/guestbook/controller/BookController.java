package com.kjisubi.guestbook.controller;
...
import com.kjisubi.guestbook.service.GuestBookService;
...
public class BookController {
    ...
    @PostMapping("/post")
    public String post(@RequestParam String post, @RequestParam String writer) {
